...
const Footer = () => {
  ...
  const footerLinks = {
    services: [
      ...
      { name: "House Renovation", path: "/services#renovation" },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          >
            ...
            <p className="text-gray-400 mb-6">
              ...
              renewable energy across Africa, North America, and Europe.
            </p>
            <div className="space-y-3">
              ...
              <p className="flex items-center text-gray-400 hover:text-gray-300 transition-colors">
                ...
                <span>info@dukedevelopersinc.com</span>
              </p>
            </div>
          </motion.div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-6 md:mb-0">
              <p className="text-gray-400">
                &copy; {currentYear} Duke Developers Inc. All rights reserved.
              </p>
            </div>
            <div className="flex space-x-4">
              {socialLinks.map((link, index) => (
                <motion.a
                  ...
                  className="text-gray-400 hover:text-white transition duration-300 flex items-center justify-center w-10 h-10 rounded-full bg-gray-800 hover:bg-gray-700"

      ...
      <div className="container mx-auto px-4 py-16">
        ...
        >
          <SectionHeading
            subtitle="Contact Us"
            title="Get In Touch"
            description="Reach out to us for any inquiries or to discuss your next project. Our team is ready to provide the expertise and solutions you need."
          />
        </motion.div>
              ...
              {formStatus.isSubmitted ? (
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <button
                    ...
                    className={`w-full md:w-auto px-8 py-3 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-medium rounded-md transition-colors duration-300 flex items-center justify-center ${
        ...
        <div className="mt-24">
          <div className="border-t border-gray-200 pt-16">
            ...
            <div className="relative rounded-xl overflow-hidden h-[400px] shadow-lg">
              <iframe
                title="Duke Developers Office Location"
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3467.566005868309!2d-95.7496118!3d29.656280899999997!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8640da9b32f6c08f%3A0xb87d2f2ec6a9a88a!2s21803%20Morton%20Rd%20Ste%20650%20%23050%2C%20Katy%2C%20TX%2077449!5e0!3m2!1sen!2sus!4v1715278587497!5m2!1sen!2sus"
        ...
        {/* FAQ Section */}
        <div className="mt-24">
          <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl p-10 text-white shadow-xl overflow-hidden relative">
            ...
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                ...
                <div>
                  ...
                  <p className="text-gray-300">
                    You can request a quote by filling out our contact form with
                    your project details, calling our main office, or emailing
                    info@dukedevelopers.com. We aim to respond to all quote
                ...
                <div>
                  ...
                  <p className="text-gray-300">
                    Yes, we offer free initial consultations for all services.
                    These can be conducted in person, via phone, or through
                    video conferencing depending on your preference and
                    location.
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-gray-300">
                    ...
                    Software projects typically range from 3-12 months,
                    construction projects from 6-24 months, and energy
                    installations from 2-9 months. We provide detailed timelines
